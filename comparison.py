...
def compare_algorithms(file_path):
    ...
    if bfs_solution:
        ...
        plot_maze(maze, bfs_explored, bfs_path, "BFS Solution", "bfs_solution.png", starting_position, destination)
    ...
    if dfs_solution:
        ...
        plot_maze(maze, dfs_explored, dfs_path, "DFS Solution", "dfs_solution.png", starting_position, destination)
